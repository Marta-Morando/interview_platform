...
STRINGS = {
    ...
    "it": {
        ...
        "empty_transcription": "Non sono riuscito a rilevare parole nella registrazione. Controlla il permesso del microfono, parla vicino al microfono e riprova, oppure scrivi la risposta.",
        "transcription_error": "Non e stato possibile trascrivere la registrazione. Riprova, oppure scrivi la risposta.",
